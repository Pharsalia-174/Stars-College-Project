...
public:
	UR_033() :MobUR(33, "梦(A)", 6, 6, 6), Mob(33, "梦(A)", 6, 6, 6) {};
};

class UR_033_A :public MeleeMob, public MobUR {
public:
	UR_033_A() :MeleeMob(33, "梦(A)", 6, 6, 6), MobUR(33, "梦(A)", 6, 6, 6), Mob(33, "梦(A)", 6, 6, 6) {};
};

class UR_033_B :public RemoteMob, public MobUR {
public:
	UR_033_B() :RemoteMob(33, "梦(B)", 6, 4, 3), MobUR(33, "梦(B)", 6, 4, 3), Mob(33, "梦(B)", 6, 4, 3) {};
};
